        ...
        <>
          ...
          <div className="absolute right-3 top-3 z-10 hidden md:flex gap-2 opacity-0 transition-opacity duration-200 group-hover:opacity-100">
            <button
              ...
              className="rounded-lg border border-border/60 bg-background/80 p-1.5 text-muted-foreground backdrop-blur-sm transition-all hover:border-primary/40 hover:text-primary cursor-pointer "
              title="Edit space">
            ...
            <button
              ...
              className="rounded-lg border border-border/60 bg-background/80 p-1.5 text-muted-foreground backdrop-blur-sm transition-all hover:border-destructive/40 hover:text-destructive cursor-pointer"
              title="Delete space">
